...
public class AddImageActivity extends AppCompatActivity {
    ...
    boolean check = true;
    String ServerUploadPath ="http://192.168.8.143/SL-athlete-care/api/v1/addImage.php" ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_image);
        imageView = (ImageView)findViewById(R.id.IVPreviewImage);
        t=findViewById(R.id.t_image_h);
        d=findViewById(R.id.t_image_d);
        SelectImageGallery = (Button)findViewById(R.id.btn_select);
        getSupportActionBar().hide();
        UploadImageServer = (Button)findViewById(R.id.button5);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(AddImageActivity.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                HashMapParams.put("case_id", "1");
                HashMapParams.put("state","0");
